...
@XmlRootElement(name = "UsageListType")
public class UsageListType {

    @XmlElement(name = "usageType")
    protected List<UsageType> usageType;
     ...
     * 
     */
    public List<UsageType> getUsageType() {
        if (usageType == null) {
        	usageType = new ArrayList<UsageType>();
        }
